...
seventy_seven = [76, 79, 80,81, 99, 113,169]
...
for l in range(0, number_of_lines - 1):
    for r in range(0, number_of_columns - 1):
        if (not (r in not_seve_or_nine)):
            if(x_train[l,r] == 7 or x_train[l,r] == 9 or x_train[l,r] == 8):
                x_train[l,r] = 0
            if (r in seven_nine_hundred):
                    if(x_train[l,r] == 777 or x_train[l,r] == 999):
                        x_train[l,r] = 0
                    if(r != 78 and r != 94):
                        if(x_train[l,r] == 888):
                            x_train[l,r] = 0
            if(r in seventy_seven):
                if(x_train[l,r] == 77 or x_train[l,r] == 99):
                    x_train[l,r] = 0
